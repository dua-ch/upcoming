<div data="<?php echo $boom['reply_id']; ?>" id="advnreply<?php echo $boom['reply_id']; ?>" class="reply_item">
	...
	<div class="reply_content">
		<div class="btable">
			...
			<?php if(canDelAdvNewsReply($boom)){ ?>
			<div onclick="deleteAdvNewsReply(<?php echo $boom['reply_id']; ?>);" class="reply_delete bcell_top">
