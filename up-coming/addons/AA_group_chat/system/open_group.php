...
<div class="pad_box">
   <div class="setting_element">
      <p class="label">اكتب اسم العضو لدعوته لمحادثه جماعية</p>
   ...
   <?php if($myGroup == ''){ ?>
   <button id="start_gchat" style="width: 100%;display: none;" class="reg_button theme_btn"><i class="fa fa-comments"></i> ابدأ المحادثة الجماعية</button>
   <?php } ?>
</div>
