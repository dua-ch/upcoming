...
if(!checkToken() || !isset($_COOKIE[BOOM_PREFIX . 'userid']) || !isset($_COOKIE[BOOM_PREFIX . 'utk'])){
	echo json_encode( array("check" => 'crap'));
	die();
}
...
user_news, user_mute, user_regmute, user_banned, user_kick, user_role, user_action, room_mute, naction, user_points, join_logs, private_ask, eshtrak_time, base_rank, my_border, no_perm, guest_notify, private_seen,
