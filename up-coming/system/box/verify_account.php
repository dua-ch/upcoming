...
<div class="pad20">
	<div id="verify_one" class="verify_zone">
		...
		<button onclick="verifyAccount(1);" class="reg_button ok_btn"><i class="fa fa-paper-plane"></i> <?php echo $lang['verify_send']; ?></button>
	...
	<div id="verify_two" class="verify_zone hidden">
		<div id="not_verify">
			...
			<button onclick="verifyAccount(2);" class="resend_hide reg_button default_btn"><i class="fa fa-paper-plane"></i> <?php echo $lang['resend']; ?></button>
		</div>
