...
else if( $command[0] == '/topic' && (boomAllow(99) || boomRole(5)) ){
...
else if($command[0] == '/removeonair' && boomAllow(100)){
...
else if($command[0] == '/setonair' && boomAllow(100)){
...
else if($command[0] == '/setdj' && boomAllow(100)){
...
else if($command[0] == '/removedj' && boomAllow(100)){
