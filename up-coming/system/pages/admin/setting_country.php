    ...
    <div id="page_wrapper">
        <div class="page_full">
            <div class="page_element item_page_title">
                <p><i class="fa fa-globe"></i> حجب الدول</p>
            </div>
        </div>
		<div class="page_full">
            <div class="page_element" id="seo_page_list">
                <select id="add_country_ban" name="add_country_ban">
					<option>اضافة دولة للحظر</option>
				...
				<button onclick="addCountryToBanned();" class="theme_btn tmargin10 reg_button"><i class="fa fa-plus-circle"></i> إضافة</button>
            </div>
        </div>
        <div class="page_full">
            <div class="page_element" id="country_page_list">
                <?php echo getBannedCountry(); ?>
            </div>
        </div>
    </div>
</div>